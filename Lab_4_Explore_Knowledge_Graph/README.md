# Lab 4: Exploring the Knowledge Graph

In this lab, you will use Neo4j Explore to visually navigate and analyze your knowledge graph. You'll learn how to search for patterns, visualize relationships, and apply graph algorithms to gain insights from your data.
...
Continue to the next lab to build applications that query your knowledge graph using natural language and AI.
