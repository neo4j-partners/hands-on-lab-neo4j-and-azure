...
Welcome to Lab 6! This lab teaches you three distinct retrieval patterns for getting context from your knowledge graph. Each pattern is optimized for different types of questions.
...
**Where we are**: You have a knowledge graph with structured entities, relationships, and vector-enabled chunks (from Lab 5).
...
Understanding *why* each retriever works for different questions prepares you for Lab 7, where you'll build agents that automatically choose the right retriever based on user questions.

## Navigation

- [← Back to Lab 5: Building Knowledge Graphs](../lab-5-knowledge-graph/README.md)
- [Start with Lesson 1: Retrievers Overview →](./01-retrievers-overview.md)
- [Skip to Lab 7: Intelligent Agents →](../lab-7-agents/README.md)
