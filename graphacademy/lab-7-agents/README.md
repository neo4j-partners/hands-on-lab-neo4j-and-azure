...
Welcome to Lab 7! This lab teaches you how to build intelligent agents that automatically choose the right retrieval strategy for each question, making your GraphRAG system conversational and user-friendly.
...
**Where we are**: You have a knowledge graph (Lab 5) and know three retrieval patterns (Lab 6).
...
- [← Back to Lab 6: GraphRAG Retrievers](../lab-6-retrievers/README.md)
