...
In my case, the URI was: http://neo4j-ee-nlb-b36b6b627f78bab6.southeastasia.cloudapp.azure.com:7474/
...
## Neo4j Bloom
Neo4j Bloom is a business intelligence (BI) tool.  It's running on that same 7474 port that the Neo4j Browser was.  So, to open it up, we can just edit that url slightly by add "bloom" to the end of it and hitting enter.  In my case, the URL was "http://neo4j-ee-nlb-b36b6b627f78bab6.southeastasia.cloudapp.azure.com:7474/bloom"
